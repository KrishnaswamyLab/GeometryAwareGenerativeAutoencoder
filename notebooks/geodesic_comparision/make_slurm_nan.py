...
with open('job.txt', 'w') as file:
    ...
    data_names = ['hemisphere_15_0.3', 'hemisphere_15_0.3', 'hemisphere_15_0.3',
       'hemisphere_15_0.5', 'saddle_15_0.1', 'saddle_50_0.1',
       'saddle_50_0.1', 'torus_15_0.5', 'torus_15_0.5', 'torus_15_0.5',
       'torus_15_0.7', 'torus_15_0.7', 'torus_15_0.7', 'torus_50_0.1',
       'torus_50_0.1']
    ...
    for data_name in data_names:
        command = f"{prepend} --cfg_main_data_name \"{data_name}\" --cfg_main_ae_sweep_id {ae_sweep_id} --cfg_main_disc_sweep_id {disc_sweep_id} --lr 1e-4 --max_epochs 200 --num_layers 2 --hidden_dim 16"
        file.write(command + '\n')
